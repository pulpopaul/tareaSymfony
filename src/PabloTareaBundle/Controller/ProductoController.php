...
use PabloTareaBundle\Entity\Producto;
use PabloTareaBundle\Form\ProductoType;
...
class ProductoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $productos = $em->getRepository('PabloTareaBundle:Producto')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('PabloTareaBundle\Form\ProductoType', $producto);
    ...
    {
        $deleteForm = $this->createDeleteForm($producto);
        $editForm = $this->createForm('PabloTareaBundle\Form\ProductoType', $producto);
